...
local baseLocale = {
	...
	["Trigger bindings on the 'down' portion of the click (only works on some frames)"] = "Trigger bindings on the 'down' portion of the click (only works on some frames)",
	["Unknown"] = "Unknown",
