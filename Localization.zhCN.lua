...
local baseLocale = {
    ...
    ["Bind spell"] = "绑定技能",
    ["Binding"] = "绑定",
	["Blizzard frame integration options"] = "暴雪界面集成选项",
    ["Boss target frames"] = "首领框体",
    ["Cancel"] = "取消",
    ["Cast %s"] = "施放 %s",
    ["Change binding"] = "修改绑定",
    ...
    ["Clique binding configuration"] = "Clique 设置",
	["Clique general options"] = "Clique 综合设置",
	...
	["Select an options category"] = "请选择选项组别",
